...
exports.loadImageFromSrcSet = loadImageFromSrcSet;
exports.resolveSrcFromSrcSet = resolveSrcFromSrcSet;
exports.srcSetToString = srcSetToString;
/**
 * Use the browser's image loading to load an image and
 * grab the `src` it chooses from a `srcSet`
 */
async function loadImageFromSrcSet({
  src,
  srcSet,
  sizes
}) {
